...
public class TwitterApp extends Activity implements OnClickListener {
	...
	protected void onResume() {
		...
		if (isConnected()) {
			String oauthAccessToken = mSharedPreferences.getString(Const.PREF_KEY_TOKEN, "RUvf1w026yuxbF4UhOjO85ctv");
			String oAuthAccessTokenSecret = mSharedPreferences.getString(Const.PREF_KEY_SECRET, "IUIDpDWRnIZG3EJbxfUMTOw7Tcoa4vrG7sykiO0ul5JGfYeeWu");
